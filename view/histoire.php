<body>
    ...
    <main>
        <div class="histoire">
            <h2>Histoire</h2>
            <img src="/public/img/histoire.png">
            <h3>Formation</h3>
            <p>La formation du toponyme viendrait de la racine indo-européenne ath- signifiant probablement « tête » ou « sommet », puisque la forteresse de l’Acropole située au sommet de la colline du même nom, constituerait le « noyau fondateur » de la ville. Ce qui expliquerait d'ailleurs l’origine de la légende mythologique portant sur la naissance d'Athéna selon laquelle la déesse, devenue protectrice de la cité, serait sortie « armée » de la tête de Zeus.
                ...
                En grec ancien, la cité s’appelait Ἀθῆναι / Athễnai et c’est sous ce nom qu’elle est devenue la capitale de l’État grec moderne. Cependant, depuis l’abandon de la katharévousa, dans les années 1970, la forme moderne Αθήνα / Athína est devenue le nom officiel de la ville (et de la mégalopole).</p>
            <h3>Antiquité</h3>
            <p>Des traces d'occupation humaine sont attestées dès le Néolithique sur le site de l'Acropole (voir Pélasges). Mais ce n'est qu'à la suite des invasions ioniennes que l'Attique fut organisée en cités, parmi lesquelles Cécropia, la future Athènes.
            ...
            <h3>Moyen Âge</h3>
            <p>Durant la période byzantine, Athènes perdit beaucoup de sa gloire pour ne devenir qu'une petite ville de province.
            ...
            <p>Dès 1821 et le déclenchement de la guerre d’Indépendance, Athènes fut libérée de l’occupation turque, mais les Grecs ne s’emparèrent de la forteresse de l’Acropole qu'en juin 1822 après un long siège. En 1826 et 1827, les Turcs assiégèrent l’Acropole, défendue d’abord par le klephte Gouras et Makriyánnis, puis, après la mort de Gouras, par le général français Fabvier. Toutes les tentatives de dégager la ville, menées par Karaïskákis puis, après son décès par l’amiral Cochrane et le général Church, échouèrent. Les troupes de Rachid Pacha prirent l’Acropole le 27 mai 1827 et y restèrent jusqu’au 12 avril 1833. La ville était quasiment inhabitée lorsqu'elle fut proclamée capitale du royaume de Grèce le 1er décembre 1834, mais elle fut rebâtie dans les décennies qui suivirent.
                ...
                En 1985, Athènes a été déclarée capitale culturelle de l'Europe.</p>
