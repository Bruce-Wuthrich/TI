<div class="contenu-page">
    ...
    <div class="img-centree">
        <img src="img/histoire.png" alt="Vue historique d'Athènes">
    </div>

    <h3>La formation</h3>
    <p>
        La formation du toponyme viendrait de la racine indo-européenne ath- signifiant probablement « tête » ou « sommet », puisque la forteresse de l’Acropole située au sommet de la colline du même nom, constituerait le « noyau fondateur » de la ville. Ce qui expliquerait d'ailleurs l’origine de la légende mythologique portant sur la naissance d'Athéna selon laquelle la déesse, devenue protectrice de la cité, serait sortie « armée » de la tête de Zeus.
